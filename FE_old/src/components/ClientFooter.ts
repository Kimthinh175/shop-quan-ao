  ...
  public static render(): string {
    return `
      <footer class="bg-[#0b0c10] text-[#c5c6c7] pt-28 pb-16 border-t border-[#1f2833]/20 relative overflow-hidden">
        <!-- Ambient light glow -->
        <div class="absolute top-0 left-1/4 w-[500px] h-[500px] bg-[#2a83e9]/80/5 rounded-full blur-[120px] pointer-events-none"></div>
          ...
          <div class="flex flex-col lg:flex-row justify-between items-start gap-16 pb-20 border-b border-slate-800/40">
            ...
            <div class="w-full lg:max-w-md">
              ...
              <div class="flex gap-2 w-full">
                ...
                <button type="submit" class="px-8 py-4 bg-white text-black font-black text-xs uppercase tracking-[0.2em] rounded-xl hover:bg-[#2a83e9] hover:text-white transition-all duration-300 shadow-lg shadow-white/5">Đăng ký</button>
              </div>
            </div>
          </div>
          ...
          <div class="grid grid-cols-2 md:grid-cols-4 gap-12 py-20 text-sm">
            <div>
              ...
              <ul class="space-y-4 text-xs font-bold text-slate-400 tracking-wider">
                <li><a href="/products" class="hover:text-white transition-all">Classic Suit</a></li>
                <li><a href="/products" class="hover:text-white transition-all">Heritage Overcoat</a></li>
                <li><a href="/products" class="hover:text-white transition-all">Merino Knitwear</a></li>
                <li><a href="/products" class="hover:text-white transition-all">Evening Dress</a></li>
              </ul>
            </div>
            <div>
              <h4 class="text-[10px] font-black uppercase tracking-[0.3em] text-white mb-8">Khám phá</h4>
              <ul class="space-y-4 text-xs font-bold text-slate-400 tracking-wider">
                <li><a href="/products" class="hover:text-white transition-all">Cửa hàng chính hãng</a></li>
