                  ...
                  ${this.state.products
                    .map((p) => {
                      ...
                      const totalQty = p.variants
                        ? p.variants.reduce(
                            (acc: number, v: any) => acc + (v._id ? 15 : 0),
                            15,
                          )
                        : 15; // fallback
                      ...
                      <tr class="hover:bg-slate-50 transition-all group">
                        <td class="px-8 py-6">
                          <div class="flex items-center gap-4">
                            ...
                            <div>
                              <p class="font-bold text-slate-800 group-hover:text-indigo-600 transition-all">${p.name}</p>
                        ...
                        <td class="px-8 py-6 font-black text-indigo-600">${price.toLocaleString()}đ</td>
